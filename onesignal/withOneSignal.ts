...
const withBituNotificationPlugin: ConfigPlugin<OneSignalPluginProps> = (
  config,
  props
) => {
  ...
  if (!props) {
    throw new Error(
      'You are trying to use the OneSignal plugin without any props. Property "mode" is required. Please see https://github.com/OneSignal/bnoti-expo-plugin for more info.'
    );
  }
